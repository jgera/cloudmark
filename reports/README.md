...
1. **[CBP-1.0 Comprehensive Benchmark Report](CBP-1.0_COMPREHENSIVE_BENCHMARK_REPORT.md)**
   - The complete consolidated paper covering all 13 evaluated machines, overall price-to-performance rankings (TPS/$), India Domestic Triangle analysis, $5 vs $6 NVMe step-up, and the $0 vs $0 Free Tier Showdown.
...
3. **[Cohort B: Micro & Entry Tier Report](COHORT_B_MICRO_AND_ENTRY.md)**
   - Detailed analysis of $0 to $10 virtual machines comparing GCP Always-Free, Vultr Free Tier ($0), GCP Delhi, Vultr Delhi ($5 & $10), Vultr Mumbai ($5), Vultr Singapore ($5), and Vultr Delhi HF NVMe ($6).
...
- **`2026-09-15_vultr_delhi_vhf-1c-1gb_run01`**: [vultr-delhi-vhf-1c-1gb-01](../runs/2026-09-15_vultr_delhi_vhf-1c-1gb_run01/derived/summary.md) (Complete; instance destroyed)
- **`2026-09-16_vultr_frankfurt_vc2-1c-0.5gb-free_run01`**: [vultr-frankfurt-vc2-1c-05gb-free-01](../runs/2026-09-16_vultr_frankfurt_vc2-1c-0.5gb-free_run01/derived/summary.md) (Complete; persistent free baseline preserved)