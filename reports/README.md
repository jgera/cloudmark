...
1. **[CBP-1.0 Comprehensive Benchmark Report](CBP-1.0_COMPREHENSIVE_BENCHMARK_REPORT.md)**
   - The complete consolidated paper covering all 12 evaluated machines, overall price-to-performance rankings (TPS/$), India Domestic Triangle analysis, $5 vs $6 NVMe step-up, and architectural decision trees.
...
3. **[Cohort B: Micro & Entry Tier Report](COHORT_B_MICRO_AND_ENTRY.md)**
   - Detailed analysis of $0 to $10 virtual machines comparing GCP Always-Free, GCP Delhi, Vultr Delhi ($5 & $10), Vultr Mumbai ($5), Vultr Singapore ($5), and Vultr Delhi High-Frequency NVMe ($6).
