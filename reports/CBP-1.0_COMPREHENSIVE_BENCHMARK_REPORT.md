...
*Compiled: 2026-09-15 11:43:49 UTC*
...
### 1.1 Evaluated Instances Matrix (11 Architectures & Regional Profiles)
...
| **Vultr `vc2-1c-1gb`** | **Singapore** | **$5.00** | **1,164.5 TPS** | **232.9 TPS / $** | 🥉 **#3 Budget Value** |
| **Vultr `vc2-1c-2gb`** | **Delhi** | **$10.00** | **2,185.1 TPS** | **218.5 TPS / $** | **#4 High-Concurrency Budget King** |
| **Vultr `vhp-4c-8gb-intel`** | **Delhi** | **$48.00** | **8,279.7 TPS** | **172.5 TPS / $** | **#5 Raw Throughput Value** |
| **Vultr `vhp-4c-8gb-amd`** | **Mumbai** | **$48.00** | **4,561.9 TPS** | **95.0 TPS / $** | **#6** |
| **GCP `c2-standard-4`** | **Iowa** | **$158.40** | **6,141.3 TPS** | **38.8 TPS / $** | **#7** |
| **GCP `t2a-standard-4` (ARM)**| **Iowa** | **$119.38** | **4,159.3 TPS** | **34.8 TPS / $** | **#8** |
| **GCP `e2-micro`** | **Delhi** | **$7.30** | **250.5 TPS** | **34.2 TPS / $** | **#9** |
| **GCP `e2-standard-4`** | **Oregon** | **$105.12** | **2,700.0 TPS** | **25.7 TPS / $** | **#10** |
...
1. **For Production Databases on a Budget ($5 – $10/mo):**
   - **Top Choice**: **Vultr Mumbai (`vc2-1c-1gb`)** or **Vultr Delhi (`vc2-1c-1gb` / `vc2-1c-2gb`)**. You get 100% sustained CPU execution, 144k–194k IOPS, and >2,000 to 2,338 sustained OLTP TPS.
