...
def compile_reports():
    ...
    idx_8 = next(i for i, l in enumerate(comp_lines) if "## 8. Architectural" in l)
    cohort_b_lines = [
        ...
        "- **Vultr `vc2-1c-0.5gb-free` (Frankfurt)** ($0.00/mo) — 1-Year Free Tier Program Leader",
